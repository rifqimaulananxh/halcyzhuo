...
export function Cta({
  ...
  sub = "Ceritain produkmu — gue kasih pandangan jujur soal scope, arsitektur, dan estimasi. Tanpa drama, tanpa jargon.",
  btnLabel = "~/lets-talk",
}: {
  pillLabel?: string;
  title?: string;
  ...
  return (
    ...
    >
      <span
        className="rv rv-label inline-flex items-center gap-2.5 text-[13px] font-medium uppercase tracking-wider"
      ...
      <TextReveal
        as="h2"
        className="text-[clamp(52px,7.5vw,88px)] font-semibold tracking-[-0.05em] leading-none max-w-[700px]"
      >
        {title}
      </TextReveal>
      <p
